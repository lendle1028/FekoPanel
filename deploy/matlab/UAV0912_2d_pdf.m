...
% [lm,ln]=size(data1);
% phi0002=data1(Freqitem:Freqnum:lm);
% vv0002=data2(Freqitem:Freqnum:lm);
% vv0002_1=data3(Freqitem:Freqnum:lm);
% 
...
CDFN1=(cumsum(N1)/sizedata2(1,1))*100;
[N2,RCS2]=hist(vv0003,RCS);
CDFN2=(cumsum(N2)/sizedata3(1,1))*100;
...
legend('\theta75~105 deg CDF','\theta75~90 deg CDF','\theta90~105 deg CDF');
%if (y2 >= 0.5) 
%disp(x2);
%disp(y2);
%end;
